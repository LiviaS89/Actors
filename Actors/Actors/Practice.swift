...
struct Practice: View {
    ...
    var actors = [Actor (name: "Keanu Reevs", movie: "Matrix", age: 55, image: "keanur", releaseDate:"October, 1999",birthCountry: "Liban", award: "Bravo Otto for the Best Actor", description: "When a beautiful stranger leads computer hacker Neo to a forbidding underworld, he discovers the shocking truth--the life he knows is the elaborate deception of an evil cyber-intelligence.", movieType: "Action Sci-Fi"),
                  ...
                  Actor (name: "Leonardo DiCaprio", movie: "Titanic", age: 47, image: "leo", releaseDate: "July,1997", birthCountry: "California", award: " Academy Award for Best Actor in a Leading Role", description: "A seventeen-year-old aristocrat falls in love with a kind but poor artist aboard the luxurious, ill-fated R.M.S. Titanic.", movieType: "Drama Romance"),
                  Actor (name: "Nicole Kidman", movie: "Far and away", age: 55, image: "nicole", releaseDate: "August, 1992", birthCountry: "Hawaii", award: "Academy Award for Best Actress", description: "A young Irish couple flee to the States, but subsequently struggle to obtain land and prosper freely.", movieType: "Adventure Drama Romance")]
